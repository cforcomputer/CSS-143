(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[66],{"/HcR":function(e,n,t){"use strict"
var r=t("O92E")
var a=t("2bDf")
var i=t("IYu7")
var o=t("V3mB")
...
return s(t)}p.rich=function(e,t,i){var o="string"===typeof e?e:e.default
var c="object"===typeof e&&e.id||u(o)
var l=g(o,c,i||n)
var s=l.toParts||(l.toParts=a.toParts(r(l.message,{tagsType:v}),i||n,f))
return s(t)}
var v="<>"
function b(e,n){var t=e[2]
return function(e,n){var r="object"===typeof t?m(t,n):t
return"function"===typeof e?e(r):e}}f[v]=b
...
c=i[n]={message:s}}return c}p.setup=function(r){r=r||{}
r.locale&&(n=r.locale)
...
f[v]=b}return{locale:n,translations:t,generateId:u,missingReplacement:d,missingTranslation:h,formats:e,types:f}}
...
p.custom=function(e,n,t,r){if(!(e[1]in f))return t
return f[e[1]](e,n)(t,r)}
p.plural=y.bind(null,"cardinal")
p.selectordinal=y.bind(null,"ordinal")
function y(e,t,r,a,c){if("object"===typeof r&&"object"!==typeof a){c=a
a=r
r=0}var l=o(c||n,i)
var s=l&&i[l][e]||x
return a["="+ +t]||a[s(t-r)]||a.other}function x(){return"other"}p.namespace=s
return p}e.exports=s()},"2bDf":function(e,n,t){"use strict"
var r=t("Hp5Y")
var a=t("V3mB")
var i=t("IYu7")
...
e=[e[0],e[1],h]}var f=s&&(r[s]||v[s])
if(f){var p=f(e,t)
return function(e){return p(l(c,e),e)}}return a?function(e){return String(l(c,e))}:function(e){return l(c,e)}}function l(e,n){if(n&&e in n)return n[e]
var t=e.split(".")
var r=n
...
return t(n)}}function f(){return"other"}function p(e,n){var t=e[2]
return function(e,n){var r=t[e]||t.other
return r(n)}}var v={number:s,ordinal:s,spellout:s,duration:u,date:d,time:d,plural:h,selectordinal:h,select:p}
n.types=v},"3UD+":function(e,n){e.exports=function(e){if(!e.webpackPolyfill){var n=Object.create(e)
...
var B=(L=Object(k["a"])(),j=Object(x["a"])(),C=Object(_["i"])(F,M),L(U=j(U=C(U=(Z=S=function(e){Object(s["a"])(n,e)
function n(){var e
var t
Object(i["a"])(this,n)
...
var t=this.props,i=t.label,o=t.children,c=t.size,l=(t.placement,t.open),s=(t.defaultFocusElement,t.contentRef),u=t.shouldContainFocus,h=t.shouldReturnFocus,f=t.shouldCloseOnDocumentClick,p=t.onOpen,g=t.onClose,x=t.onDismiss,_=t.mountNode,k=t.insertAt,O=t.liveRegion,F=t.onEnter,L=t.onEntering,j=t.onEntered,C=t.onExit,U=t.onExiting,S=t.onExited,Z=t.onTransition,B=t.border,E=t.shadow,T=Object(a["a"])(t,["label","children","size","placement","open","defaultFocusElement","contentRef","shouldContainFocus","shouldReturnFocus","shouldCloseOnDocumentClick","onOpen","onClose","onDismiss","mountNode","insertAt","liveRegion","onEnter","onEntering","onEntered","onExit","onExiting","onExited","onTransition","border","shadow"])
var G=l||this.state.transitioning
return d.a.createElement(w["a"],{open:G,onOpen:this.handlePortalOpen,insertAt:k,mountNode:_},G&&d.a.createElement(z["a"],{in:l,type:this.transition,onTransition:Z,onEnter:F,onEntering:L,onEntered:Object(y["a"])(this.handleTransitionComplete,j,p),onExit:C,onExiting:U,onExited:Object(y["a"])(this.handleTransitionComplete,S,g),transitionOnMount:true,transitionEnter:true,transitionExit:true},d.a.createElement("span",Object.assign({},Object(m["a"])(T,n.propTypes),{className:v()((e={},Object(r["a"])(e,M.root,true),Object(r["a"])(e,M.border,B),Object(r["a"])(e,M.shadow,E),Object(r["a"])(e,M[c],true),Object(r["a"])(e,M["placement--".concat(this.props.placement)],true),e)),ref:s}),this.state.transitioning?o:d.a.createElement(b["a"],{as:"div",label:i,defaultFocusElement:this.defaultFocusElement,open:true,shouldContainFocus:u,shouldReturnFocus:h,shouldCloseOnDocumentClick:f,shouldCloseOnEscape:true,liveRegion:O,onDismiss:x},d.a.createElement("div",{className:M.content},o)))))}},{key:"placement",get:function(){var e=this.props.placement
...
return o+e.replace(/'/g,c)+o}function p(e){var n=e[0]
var t=e[1]
var r=e[2]
var a=e[3]
...
this._textarea&&!this._textareaResizeListener&&(this._textareaResizeListener=Object(x["a"])(this._textarea,this._textareaResize,["height"]))
this._request=Object(_["a"])(this.grow)}}},{key:"focus",value:function(){this._textarea.focus()}},{key:"render",value:function(){var e,t=this
var a=this.props,i=a.autoGrow,o=a.placeholder,c=a.value,l=a.defaultValue,s=a.disabled,u=a.readOnly,h=a.required,f=a.width,p=a.height,b=a.maxHeight,g=a.textareaRef,y=a.resize,x=a.size
var _=Object(j["a"])(this.props,n.propTypes)
var k=(e={},Object(r["a"])(e,E.textarea,true),Object(r["a"])(e,E[x],true),Object(r["a"])(e,E.disabled,s),e)
var w={width:f,resize:y,height:i?null:p,maxHeight:b}
...
g.apply(t,[e].concat(r))},style:w,id:this.id,required:h,"aria-required":h,"aria-invalid":this.invalid?"true":null,disabled:s||u,className:v()(k),onChange:this.handleChange}))
return d.a.createElement(m["a"],Object.assign({},Object(j["c"])(this.props,m["a"].propTypes),{vAlign:"top",id:this.id,ref:function(e){t._node=e}}),d.a.createElement("div",{className:E.layout,style:{width:f,maxHeight:b},ref:this.handleContainerRef},O,s||u?null:d.a.createElement("span",{className:E.outline,"aria-hidden":"true"})))}},{key:"minHeight",get:function(){return this._textarea.style.minHeight}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"focused",get:function(){return Object(k["a"])(this._textarea)}},{key:"value",get:function(){return this._textarea.value}}])
...
r<e.index&&e.tokens&&e.tokens.push(["space",e.pattern.slice(r,e.index)])}function y(e){var n=e.pattern
...
return u}function x(e){var n=e.tagsType
...
g(e)
i[o]=F(e,n)
g(e)}if(!i.other&&p.indexOf(n)>=0)throw L(e,null,null,'"other" sub-message must be specified in '+n)
...
return t}Object(o["a"])(n,[{key:"focus",value:function(){Object(x["a"])(this._link).focus()}},{key:"renderIcon",value:function(){var e=this.props.icon
this.props.display
...
var y=(e={},Object(a["a"])(e,M.root,true),Object(a["a"])(e,M.inverse,"inverse"===s),Object(a["a"])(e,M["iconPlacement--".concat(p)],f&&this.hasVisibleChildren),Object(a["a"])(e,M.truncates,this.containsTruncateText),e)
var x=l&&"button"!==this.element?"button":null
var _="button"===this.element||"input"===this.element?"button":null
var w="button"!==x||o?null:"0"
...
"function"===typeof g&&g(e)},as:this.element,display:this.display,margin:h,className:v()(y),href:u,onClick:this.handleClick,"aria-disabled":o?"true":null,role:x,type:_,tabIndex:w})
...
return this.props.icon?this.containsTruncateText?"flex":"inline-block":this.containsTruncateText?"block":"auto"}},{key:"hasVisibleChildren",get:function(){return Object(g["a"])(this.props.children)}},{key:"element",get:function(){return Object(w["a"])(n,this.props)}},{key:"focused",get:function(){return Object(_["a"])(this._link)}},{key:"focusable",get:function(){return Object(y["a"])(this._link)}},{key:"containsTruncateText",get:function(){var e=false
d.a.Children.forEach(this.props.children,(function(n){n&&Object(O["a"])(n,["TruncateText"])&&(e=true)}))
!e||this.props.display
return e}}])
n.displayName="Link"
return n}(u["Component"]),S.propTypes={href:f.a.string,children:f.a.node.isRequired,variant:f.a.oneOf(["default","inverse"]),linkRef:f.a.func,elementRef:f.a.func,as:f.a.elementType,disabled:f.a.bool,onClick:f.a.func,margin:m["c"].spacing,icon:f.a.oneOfType([f.a.func,f.a.element]),iconPlacement:f.a.oneOf(["start","end"]),display:f.a.oneOf(["auto","block","inline-block","flex","inline-flex"])},S.defaultProps={href:void 0,elementRef:void 0,disabled:false,onClick:void 0,margin:void 0,icon:void 0,display:void 0,variant:"default",as:void 0,linkRef:function(e){},iconPlacement:"start"},Z))||U)||U)},SLVX:function(e,n,t){"use strict"
...
n["default"]=o}).call(this,t("yLpj"),t("3UD+")(e))},"gSD+":function(e,n,t){"use strict"
var r=t("rePB")
var a=t("1OyB")
var i=t("vuIU")
var o=t("md7G")
...
var v=t("n12J")
var b=t("J2CL")
function m(e,n,t){if("input"===e.as){if("children"===n&&e.children||void 0==e.value)return new Error("Prop `value` and not `children` must be supplied if `".concat(t,' as="input"`'))}else{if("value"===n&&void 0!=e.value)return new Error("Prop `children` and not `value` must be supplied unless `".concat(t,' as="input"`'))
if(!e.children)return new Error("Prop `children` should be supplied unless `".concat(t,' as="input"`.'))}return}var g=t("KgFQ")
var y=t("jtGx")
var x=t("oXx0")
function _(e){var n=e.borders,t=e.colors,r=e.spacing,a=e.typography
...
var h=Object(g["a"])(n,this.props,(function(){return"reset"===c?"span":c}))
var f=v["a"].omitViewProps(Object(y["a"])(this.props,n.propTypes),n)
return u.a.createElement(v["a"],Object.assign({},f,{className:p()((e={},Object(r["a"])(e,L.root,true),Object(r["a"])(e,L[c],true),Object(r["a"])(e,L["color-".concat(o)],o),Object(r["a"])(e,L["border-".concat(a)],"none"!==a),Object(r["a"])(e,L.ellipsis,l),e)),as:h,margin:s,elementRef:d,__dangerouslyIgnoreExperimentalWarnings:true}),i)}}])
n.displayName="Heading"
return n}(s["Component"]),z.propTypes={border:h.a.oneOf(["none","top","bottom"]),children:m,color:h.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:h.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:h.a.elementType,ellipsis:h.a.bool,margin:b["c"].spacing,elementRef:h.a.func},z.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2",ellipsis:false},F))||O)||O)},syYy:function(e,n,t){"use strict"
var r=t("vAQ1")
var a=t("ZoNA")
...
//# sourceMappingURL=66-c-7c6534264e.js.map