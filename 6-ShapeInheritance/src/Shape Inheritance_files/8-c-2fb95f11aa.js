(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[8],{sTNg:function(e,n,t){"use strict"
var a=t("1OyB")
var r=t("vuIU")
var i=t("md7G")
var o=t("foSv")
...
var L=(R=Object(j["i"])(T,z),R(B=(V=N=function(e){Object(s["a"])(n,e)
function n(){Object(a["a"])(this,n)
return Object(i["a"])(this,Object(o["a"])(n).apply(this,arguments))}Object(r["a"])(n,[{key:"render",value:function(){var e
var n=(e={},Object(h["a"])(e,z.root,true),Object(h["a"])(e,z[this.props.variant],true),e)
return"screenreader-only"!==this.props.variant?c.a.createElement("span",{className:g()(n)},this.props.children):c.a.createElement(y["a"],{__dangerouslyIgnoreExperimentalWarnings:true},this.props.children)}}])
n.displayName="FormFieldMessage"
return n}(l["Component"]),N.propTypes={variant:p.a.oneOf(["error","hint","success","screenreader-only"]),children:p.a.node},N.defaultProps={variant:"hint",children:null},V))||B)
var W,G,D,M
...
var X=(W=Object(j["i"])(F,J),W(G=(M=D=function(e){Object(s["a"])(n,e)
function n(){Object(a["a"])(this,n)
return Object(i["a"])(this,Object(o["a"])(n).apply(this,arguments))}Object(r["a"])(n,[{key:"render",value:function(){var e=this.props.messages
return e&&e.length>0?c.a.createElement("span",Object.assign({className:J.root},Object(u["a"])(this.props,n.propTypes)),e.map((function(e,n){return c.a.createElement("span",{key:"error".concat(n),className:J.message},c.a.createElement(L,{variant:e.type},e.text))}))):null}}])
n.displayName="FormFieldMessages"
return n}(l["Component"]),D.propTypes={messages:p.a.arrayOf(m.message)},D.defaultProps={messages:void 0},M))||G)
...
var K=(P=Object(j["i"])(H,Q),P(U=(Y=q=function(e){Object(s["a"])(n,e)
function n(e){var t
Object(a["a"])(this,n)
...
function n(){Object(a["a"])(this,n)
return Object(i["a"])(this,Object(o["a"])(n).apply(this,arguments))}Object(r["a"])(n,[{key:"render",value:function(){return c.a.createElement(K,Object.assign({},Object(u["a"])(this.props,n.propTypes),Object(u["c"])(this.props,K.propTypes),{vAlign:this.props.vAlign,as:"label",htmlFor:this.props.id}))}}])
...
var $=function(e){var n=e.borders,t=e.colors,a=e.spacing
...
var ie=(ee=Object(j["i"])($,re),ee(ne=(ae=te=function(e){Object(s["a"])(n,e)
function n(){Object(a["a"])(this,n)
return Object(i["a"])(this,Object(o["a"])(n).apply(this,arguments))}Object(r["a"])(n,[{key:"renderColumns",value:function(){return l["Children"].map(this.props.children,(function(e,n){return e?c.a.createElement(O["a"].Col,{width:e.props&&e.props.width?"auto":null,key:n},e):null}))}},{key:"renderChildren",value:function(){return c.a.createElement(O["a"],{colSpacing:this.props.colSpacing,rowSpacing:this.props.rowSpacing,vAlign:this.props.vAlign,startAt:this.props.startAt||("columns"===this.props.layout?"medium":null)},c.a.createElement(O["a"].Row,null,this.renderColumns()))}},{key:"renderFields",value:function(){var e
return c.a.createElement("span",{key:"fields",className:g()((e={},Object(h["a"])(e,re.fields,true),Object(h["a"])(e,re.invalid,this.invalid),Object(h["a"])(e,re.disabled,this.props.disabled),e))},this.renderChildren())}},{key:"render",value:function(){return c.a.createElement(K,Object.assign({},Object(u["a"])(this.props,n.propTypes),Object(u["c"])(this.props,K.propTypes),{vAlign:this.props.vAlign,layout:"inline"===this.props.layout?"inline":"stacked",label:this.props.description,"aria-disabled":this.props.disabled?"true":null,"aria-invalid":this.invalid?"true":null}),this.renderFields())}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}}])
n.displayName="FormFieldGroup"
return n}(l["Component"]),te.propTypes={description:p.a.node.isRequired,as:p.a.elementType,messages:p.a.arrayOf(m.message),messagesId:p.a.string,disabled:p.a.bool,children:p.a.node,layout:p.a.oneOf(["stacked","columns","inline"]),rowSpacing:p.a.oneOf(["none","small","medium","large"]),colSpacing:p.a.oneOf(["none","small","medium","large"]),vAlign:p.a.oneOf(["top","middle","bottom"]),startAt:p.a.oneOf(["small","medium","large","x-large",null])},te.defaultProps={children:null,layout:void 0,startAt:void 0,messages:void 0,messagesId:void 0,as:"fieldset",disabled:false,rowSpacing:"medium",colSpacing:"small",vAlign:"middle"},ae))||ne)
t.d(n,"a",(function(){return Z}))
t.d(n,"d",(function(){return X}))
t.d(n,"c",(function(){return K}))
t.d(n,"b",(function(){return ie}))
t.d(n,"e",(function(){return m}))}}])

//# sourceMappingURL=8-c-2fb95f11aa.js.map